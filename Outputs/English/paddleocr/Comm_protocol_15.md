...
o  Detects obstacles and sets the Object_Detected signal when an obstacle is
within a threshold..
o Transmits the signal using the CAN protocol
2. CAN Transmitter (TX) Module
o Encodes the Ob ject_Detected signal into a CAN frame
