...
<sup>2.</sup> Tensorflow code for Switch Transformer is available at https://github.com/tensorflow/mesh/blob/ master/mesh\_tensorflow/transformer/moe.py
...
| 6 | Related Work<br>24                                                                                                                                                                                                                                                                                           |                                        |  |  |  |  |
| 7 | Discussion<br>25                                                                                                                                                                                                                                                                                             |                                        |  |  |  |  |
| 8 | Future Work<br>26                                                                                                                                                                                                                                                                                            |                                        |  |  |  |  |
| 9 | Conclusion                                                                                                                                                                                                                                                                                                   |                                        |  |  |  |  |
| A | Switch for Attention                                                                                                                                                                                                                                                                                         |                                        |  |  |  |  |
| B | Preventing Token Dropping with<br>No-Token-Left-Behind                                                                                                                                                                                                                                                       |                                        |  |  |  |  |
...
where f<sup>i</sup> is the fraction of tokens dispatched to expert i,

$$f_i = \frac{1}{T} \sum_{x \in \mathcal{B}} \mathbb{1}\{\operatorname{argmax} p(x) = i\}$$
 (5)

and P<sup>i</sup> is the fraction of the router probability allocated for expert i, 2
...
<sup>2.</sup> A potential source of confusion: pi(x) is the probability of routing token x to expert i. P<sup>i</sup> is the probability fraction to expert i across all tokens in the batch B.
...
| Model        | Capacity<br>Factor | Quality after<br>100k steps (↑) | Time to Quality<br>Threshold (↓) | Speed (↑)<br>(examples/sec) |
|--------------|--------------------|---------------------------------|----------------------------------|-----------------------------|
|              |                    | (Neg. Log Perp.)                | (hours)                          |                             |
