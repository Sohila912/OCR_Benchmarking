...
2. Tensorflow code for Switch Transformer is available at https://github.com/tensorflow/mesh/blob/master/mesh_tensorflow/transformer/meo.py
...
\[
p _ {i} (x) = \frac {e ^ {h (x) _ {i}}}{\sum_ {j} ^ {N} e ^ {h (x) _ {j}}}. \tag {1}
\]
...
\[
y = \sum_ {i \in \mathcal {T}} p _ {i} (x) E _ {i} (x). \tag {2}
\]
...
\[
\text { loss } = \alpha \cdot N \cdot \sum_ {i = 1} ^ {N} f _ {i} \cdot P _ {i} \tag {4}
\]
where  \( f_{i} \)  is the fraction of tokens dispatched to expert i,
\[
f _ {i} = \frac {1}{T} \sum_ {x \in \mathcal {B}} \mathbb {1} \left\{\operatorname{argmax} p (x) = i \right\} \tag {5}
\]
and \( P_{i} \) is the fraction of the router probability allocated for expert \( i \), \( ^{2} \)
\[
P _ {i} = \frac {1}{T} \sum_ {x \in \mathcal {B}} p _ {i} (x). \tag {6}
\]
...
<PAGE>
SWITCH TRANSFORMERS
<table><tr><td>Model</td><td>Capacity Factor</td><td>Quality after 100k steps (\( \uparrow \)) (Neg. Log Perp.)</td><td>Time to Quality Threshold (\( \downarrow \)) (hours)</td><td>Speed (\( \uparrow \)) (examples/sec)</td></tr><tr><td>T5-Base</td><td>—</td><td>-1.731</td><td>Not achieved\( ^{\dagger} \)</td><td>1600</td></tr><tr><td>T5-Large</td><td>—</td><td>-1.550</td><td>131.1</td><td>470</td></tr><tr><td>MoE-Base</td><td>2.0</td><td>-1.547</td><td>68.7</td><td>840</td></tr><tr><td>Switch-Base</td><td>2.0</td><td>-1.554</td><td>72.8</td><td>860</td></tr><tr><td>MoE-Base</td><td>1.25</td><td>-1.559</td><td>80.7</td><td>790</td></tr><tr><td>Switch-Base</td><td>1.25</td><td>-1.553</td><td>65.0</td><td>910</td></tr><tr><td>MoE-Base</td><td>1.0</td><td>-1.572</td><td>80.1</td><td>860</td></tr><tr><td>Switch-Base</td><td>1.0</td><td>-1.561</td><td>62.8</td><td>1000</td></tr><tr><td>Switch-Base+</td><td>1.0</td><td>-1.534</td><td>67.6</td><td>780</td></tr></table>
