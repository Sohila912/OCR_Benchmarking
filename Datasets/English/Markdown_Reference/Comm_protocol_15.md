...
1.  **Object Detection Module**
    *   Detects obstacles and sets the **Object_Detected** signal when an obstacle is within a threshold.
    *   Transmits the signal using the CAN protocol.
2.  **CAN Transmitter (TX) Module**
    *   Encodes the **Object_Detected** signal into a CAN frame.
...
4.  **CAN Receiver (RX) Module**
    ...
    *   Extracts the **Object_Detected** signal.
5.  **Braking System Module**
    *   Receives the **Object_Detected** signal.
    *   Activates braking if **Object_Detected** is asserted.
