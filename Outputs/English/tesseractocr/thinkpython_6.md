...
Formal languages tend to have strict rules about syntax. For example,3+3 = 6isa
...
problems with 3+ = 366 is that $ is not a legal token in mathematics (at least as far as I
